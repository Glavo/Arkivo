...
/// public blocking channel contracts and apply explicit ownership to the compressed-data endpoint. Provider code must
/// not reuse a stateful engine between returned contexts.
@NotNullByDefault
