...
val localFuzzTasks = mapOf(
    ...
    "fuzzArchiveWriterState" to "Fuzzes streaming archive writer state transitions and round trips.",
    "fuzzArchiveVolumes" to "Fuzzes multi-volume archive parsing and resource ownership.",
